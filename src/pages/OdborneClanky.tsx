...
const articles = [
  ...
  },
  {
    ...
    description: "Značky, patenty, zákaznícke vzťahy či know-how – nehmotné aktíva majú zásadný vplyv na hodnotu firmy. Na ich ocenenie sa používa metóda MPEEM v kombinácii s CAC.",
  ...
  },
  {
    ...
    description: "Pri predaji firmy sa opakujú tie isté chyby, ktoré dokážu znížiť kúpnu cenu aj o desiatky percent. Správne ocenenie je nástroj, ktorý dáva vyjednávaciu silu.",
  ...
  },
  {
    ...
    description: "Aká je hodnota Vašej značky či patentov? Prehľad prístupov – nákladový, trhový a výnosový – a čo všetko možno oceniť.",
  ...
  },
  {
    ...
    description: "Pracovná sila je kľúčové aktívum pri akvizíciách. Ako sa určuje jej hodnota pomocou nákladového prístupu a prečo je dôležitá pri PPA.",
  ...
  },
  {
    ...
    description: "IFRS a IVS majú odlišné ciele a prístupy k oceňovaniu nehmotných aktív. Pochopenie týchto rozdielov je kľúčové pre správnu valuáciu.",
  ...
  },
  {
    ...
    description: "Kvalitný finančný model prináša transparentnosť, flexibilitu a dôveryhodnosť. Je ako mapa – bez nej je cesta plná neistoty.",
  ...
  },
  {
    ...
    description: "Reštrukturalizácia nie je zlyhanie – je to príležitosť získať druhý dych. Finančná, prevádzková aj strategická reštrukturalizácia v praxi.",
